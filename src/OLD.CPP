...
//	if (FALSE == MIDASsetTimerCallbacks(s_midasRefresh, TRUE, &MIDAS_PreVR, &MIDAS_ImmVR, &MIDAS_InVR))
	...
	int trackIdx = TRACK_GRAND_PRIX_CIRCUIT;
...
// Accolade part:
Image accolade("gfx\\accolade", 320, 240, 64, 0);

// Credits part:
Image crd_logo("gfx\\crd_logo", 320, 136, 32, 0);
Font crd_font("gfx\\crd_font", 960, 16, 16, 8, 32);

// Menu part:
Image mnu_logo("gfx\\mnu_logo", 320, 122, 16, 0);
Image mnu_grp("gfx\\mnu_grp", 320, 122, 16, 16);

Font mnu_font("gfx\\mnu_font", 1024, 9, 16, 2, 16+16);
Font mnu_arr("gfx\\mnu_arr", 32, 32, 16, 7, 16+16+2);

// Greetings part:
Image grt_girl("gfx\\grt_girl", 320, 240, 32, 0);
Font grt_font("gfx\\grt_font", 1090, 16, 16, 24, 32);
...
public:
	...
	/* virtual */ void Prepare() 
	{
		Audio_SelectTrack(TRACK_OUTLINE);
	}
